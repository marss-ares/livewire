        ...
        <div class="flex items-center justify-between w-full">
            ...
            <div class="flex-none">
                <form autocomplete="off" onsubmit="return false">
                    <div class="relative">
                        <svg class="absolute left-2.5 top-1/2 -translate-y-1/2 w-4 h-4 text-zinc-400 pointer-events-none" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <input
                            ...
                            autocomplete="off"
                            class="w-64 h-8 pl-8 pr-3 text-sm rounded-lg border border-zinc-200 dark:border-zinc-600 bg-white dark:bg-zinc-700 text-zinc-800 dark:text-zinc-100 placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
                        />
                    </div>
                </form>
            </div>
