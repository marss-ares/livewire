<flux:modal wire:model="showModal" class="md:w-[560px] space-y-6">
    <div>
        ...
        <flux:subheading>Fill in the details and select permissions.</flux:subheading>
    </div>

    <div class="space-y-4">
        <flux:input label="Role Name" placeholder="e.g. Moderator" wire:model.live="name" />
        <flux:input label="Slug" placeholder="auto-generated" wire:model="slug" />
